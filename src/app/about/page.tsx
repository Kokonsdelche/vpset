                                ...
                                <section className="mb-20">
                                        <div className="max-w-3xl mx-auto text-center">
                                                ...
                                                <p className="text-xl text-gray-300 mb-8">
                                                        ما یک تیم متخصص نرم افزاری در زمینه معاملات آپشن و DeFi هستیم که با هدف کمک به معامله‌گران ایرانی،
                                                        این پلتفرم به این جهت این  را راه‌اندازی کرده‌ایم تا بتوانید با داشتن یک vpn یا vps خوب و سریع با اطمینان خاطر مشغول به معملات خود با باشید تمام سرورهای ما میکرو تیک هستند و خارج از کشور ایران خریداری و تنظیم میگردد واز شرکتها معتبرکشورهای فرانسه ,هلند ,انگلیس ,برزیل,امارات متحده عربی , هندوستان  برای خدمات دهی به شما استفاده میکنم .
                                                </p>
