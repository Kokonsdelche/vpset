...
const slides = [
        {
                ...
                title: "با vpn اختصاصی و IP ثابت معاملات آپشن بدون واسطه",
                desc: "در Derive معاملات آپشن را به صورت غیرمتمرکز  با vpn اختصاصی  طرح رایگان و طرح آبانمان ماهیانه ما تجربه کنید."
        },
        {
                image: "/slider/slide2.jpg",
                title: "در  صورت نیاز به خرید vps اختصاصی و پر سرعت به تمامی صرافی ها و بروکر ها  دنیا با امنیت کامل متصل شوید ",
                desc: "سرعت اینترنت متناسب با سرعت اینترنت داخلی خودتان."
        },
        {
                image: "/slider/slide1.jpg",
